...
function ButtonRow(props) {
  ...
  <div>
    ...
    {buttonObj.map((button,index) => (
        <Button key={"row"+props.row+"-btn"+button.id} value={props.numbers[button.id]}  rowClick={buttonRowClick} padding={button.padding} nextVal={props.correctRow[count]}></Button>
